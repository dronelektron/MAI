...
public class Graph {
	...
	public GraphEdge findEdge(double x, double y) {
		for (GraphEdge ge : edges) {
			double ax = ge.getAreaX();
			double ay = ge.getAreaY();
			double dx = x - ax;
			double dy = y - ay;
			double r = GraphVertex.RADIUS;
	...
	public void setCurVertex(GraphVertex curVertex) {
		this.curVertex = curVertex;
	}

	public void setCurEdge(GraphEdge curEdge) {
		this.curEdge = curEdge;
	}

	public GraphVertex getCurVertex() {
		return curVertex;
	}

	public GraphEdge getCurEdge() {
		return curEdge;
	}
