...
public class HandlerFigures implements ChangeListener<Number>, EventHandler<MouseEvent> {
	public HandlerFigures(Canvas canvas, TabPane tabPane, Slider[] paramsFig1, Slider[] paramsFig2, Slider[] paramsFig3) {
		prevMouseX = 0.0;
		prevMouseY = 0.0;
		this.canvas = canvas;
		this.tabPane = tabPane;
		figures = new Figure[] {new Figure1(paramsFig1), new Figure2(paramsFig2), new Figure3(paramsFig3), new CoordsSystemFigure()};
